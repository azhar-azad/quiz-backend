...
public class QuestionController {
	...
	@PostMapping
	public QuestionRest createQuestion(@RequestBody QuestionDetailsRequestModel questionDetails) {
		
		QuestionDto questionDto = modelMapper.map(questionDetails, QuestionDto.class);
		
		QuestionDto createdQuestion = questionService.createQuestion(questionDto);
		
		QuestionRest returnValue = modelMapper.map(createdQuestion, QuestionRest.class);
		return returnValue;
	}
